...
impl CPU {
    ...
    pub(super) fn dispatch(&mut self, bus: &mut Bus, opcode: u8) {
        ...
        match opcode {
            ...
            0b00_000_011 => self.inc_ww(bus, RegW::BC),
            0b00_000_100 => self.inc_g_hl(bus, RegGHL::B),
            0b00_000_101 => self.error(),
            0b00_000_110 => self.ld_g_hl_m(bus, RegGHL::B),
            0b00_000_111 => self.error(),

            0b00_001_000 => self.error(),
            0b00_001_001 => self.error(),
            0b00_001_010 => self.error(),
            0b00_001_011 => self.error(),
            0b00_001_100 => self.inc_g_hl(bus, RegGHL::C),
            0b00_001_101 => self.error(),
            0b00_001_110 => self.ld_g_hl_m(bus, RegGHL::C),
            ...
            0b00_010_011 => self.inc_ww(bus, RegW::DE),
            0b00_010_100 => self.inc_g_hl(bus, RegGHL::D),
            0b00_010_101 => self.error(),
            0b00_010_110 => self.ld_g_hl_m(bus, RegGHL::D),
            0b00_010_111 => self.error(),

            0b00_011_000 => self.error(),
            0b00_011_001 => self.error(),
            0b00_011_010 => self.error(),
            0b00_011_011 => self.error(),
            0b00_011_100 => self.inc_g_hl(bus, RegGHL::E),
            0b00_011_101 => self.error(),
            0b00_011_110 => self.ld_g_hl_m(bus, RegGHL::E),
            0b00_011_111 => self.error(),

            0b00_100_000 => self.error(),
            0b00_100_001 => self.ld_ww_mn(bus, RegW::HL),
            0b00_100_010 => self.error(),
            0b00_100_011 => self.inc_ww(bus, RegW::HL),
            0b00_100_100 => self.inc_g_hl(bus, RegGHL::H),
            0b00_100_101 => self.error(),
            0b00_100_110 => self.ld_g_hl_m(bus, RegGHL::H),
            0b00_100_111 => self.error(),

            0b00_101_000 => self.error(),
            0b00_101_001 => self.error(),
            0b00_101_010 => self.error(),
            0b00_101_011 => self.error(),
            0b00_101_100 => self.inc_g_hl(bus, RegGHL::L),
            0b00_101_101 => self.error(),
            0b00_101_110 => self.ld_g_hl_m(bus, RegGHL::L),
            0b00_101_111 => self.error(),

            0b00_110_000 => self.error(),
            0b00_110_001 => self.ld_ww_mn(bus, RegW::SP),
            0b00_110_010 => self.error(),
            0b00_110_011 => self.inc_ww(bus, RegW::SP),
            0b00_110_100 => self.inc_g_hl(bus, RegGHL::HL),
            0b00_110_101 => self.error(),
            0b00_110_110 => self.ld_g_hl_m(bus, RegGHL::HL),
            0b00_110_111 => self.error(),

            0b00_111_000 => self.error(),
            0b00_111_001 => self.error(),
            0b00_111_010 => self.error(),
            0b00_111_011 => self.error(),
            0b00_111_100 => self.inc_g_hl(bus, RegGHL::A),
            0b00_111_101 => self.error(),
            0b00_111_110 => self.ld_g_hl_m(bus, RegGHL::A),
            ...
            0b10_001_000 => self.error(),
            0b10_001_001 => self.error(),
            0b10_001_010 => self.error(),
            0b10_001_011 => self.error(),
            0b10_001_100 => self.error(),
            0b10_001_101 => self.error(),
            0b10_001_110 => self.error(),
            0b10_001_111 => self.error(),

            0b10_010_000 => self.error(),
            0b10_010_001 => self.error(),
            0b10_010_010 => self.error(),
            0b10_010_011 => self.error(),
            0b10_010_100 => self.error(),
            0b10_010_101 => self.error(),
            0b10_010_110 => self.error(),
            0b10_010_111 => self.error(),

            0b10_011_000 => self.error(),
            0b10_011_001 => self.error(),
            0b10_011_010 => self.error(),
            0b10_011_011 => self.error(),
            0b10_011_100 => self.error(),
            0b10_011_101 => self.error(),
            0b10_011_110 => self.error(),
            0b10_011_111 => self.error(),

            0b10_100_000 => self.error(),
            0b10_100_001 => self.error(),
            0b10_100_010 => self.error(),
            0b10_100_011 => self.error(),
            0b10_100_100 => self.error(),
            0b10_100_101 => self.error(),
            0b10_100_110 => self.error(),
            0b10_100_111 => self.error(),
            ...
            0b11_000_011 => self.error(),
            0b11_000_100 => self.error(),
            0b11_000_101 => self.error(),
            0b11_000_110 => self.error(),
            ...
            //x if x & 0b11_111_111 == 0b11_101_101 => self.extended(bus),
            //x if x & 0b11_111_111 == 0b11_000_011 => self.jp(bus),
        }
    }
}

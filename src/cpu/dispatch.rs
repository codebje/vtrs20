...
impl CPU {
    ...
    pub(super) fn dispatch(&mut self, bus: &mut Bus) {
        ...
        match opcode {
            ...
            0b10_010_000 => self.sub_a(bus, Operand::Direct(Register::B), false),
            0b10_010_001 => self.sub_a(bus, Operand::Direct(Register::C), false),
            0b10_010_010 => self.sub_a(bus, Operand::Direct(Register::D), false),
            0b10_010_011 => self.sub_a(bus, Operand::Direct(Register::E), false),
            0b10_010_100 => self.sub_a(bus, Operand::Direct(Register::H), false),
            0b10_010_101 => self.sub_a(bus, Operand::Direct(Register::L), false),
            0b10_010_110 => self.sub_a(bus, Operand::Indirect(RegIndirect::HL), false),
            0b10_010_111 => self.sub_a(bus, Operand::Direct(Register::A), false),

            0b10_011_000 => self.sub_a(bus, Operand::Direct(Register::B), true),
            0b10_011_001 => self.sub_a(bus, Operand::Direct(Register::C), true),
            0b10_011_010 => self.sub_a(bus, Operand::Direct(Register::D), true),
            0b10_011_011 => self.sub_a(bus, Operand::Direct(Register::E), true),
            0b10_011_100 => self.sub_a(bus, Operand::Direct(Register::H), true),
            0b10_011_101 => self.sub_a(bus, Operand::Direct(Register::L), true),
            0b10_011_110 => self.sub_a(bus, Operand::Indirect(RegIndirect::HL), true),
            0b10_011_111 => self.sub_a(bus, Operand::Direct(Register::A), true),
            ...
            0b11_010_110 => self.sub_a(bus, Operand::Immediate(), false),
            ...
            0b11_011_110 => self.sub_a(bus, Operand::Immediate(), true),
            ...
            0b11_111_001 => self.ld_16(
                bus,
                Operand::Direct(Register::HL),
